...
### 📊 Records \& Reports
- Display: All registered pets, appointments for a specific pet, upcoming appointments for all pets and past appointment history  
- Generate reports: Pets with appointments in the next 7 days and pets overdue for a vet visit (no visit in last 6 months)
...
├── Pet.java               # Pet class
├── PetCareScheduler.java  # Main application
├── pets.txt               # Stores pet data
└── README.md
```
